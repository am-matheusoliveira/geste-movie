...
(5828,'Garfield - Fora de Casa','Garfield, o mundialmente famoso gato de interior que odeia segundas-feiras e adora lasanha, está prestes a ter uma aventura selvagem ao ar livre! Depois de um reencontro inesperado com seu pai há muito perdido – o desalinhado gato de rua Vic – Garfield e seu amigo canino Odie são forçados a deixar sua vida perfeitamente mimada para se juntarem a Vic em um assalto hilariante e de alto risco.',2024,101,100,32,1,1,'2024-07-10 14:48:07','2024-07-10 17:48:07'),
...
SELECT 
    ...
    CASE
		WHEN(A.age_rating = 100)THEN 'LIVRE'
